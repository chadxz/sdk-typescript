...
export class MockActivityEnvironment extends events.EventEmitter {
   ...
   */
  public async run<F extends ActivityFunction>(fn: F, ...args: Parameters<F>): Promise<ReturnType<F>> {
    return this.activity.runNoEncoding(fn, { args, headers: {} }) as Promise<ReturnType<F>>;
  }
}
